param(
    ...
    [string]$LogPath = "F:\egg baseline\DMMR\logs\quick_tgb_sspb_v2_gcnres_selfloop_dropout.log"
)
...
try {
    & $Python "$repoRoot\main.py" `
        ...
        --use_pre_lstm_dropout `
        --pre_lstm_dropout_p 0.1 `
        --way outputs/quick_tgb_sspb_v2_gcnres_selfloop_dropout `
